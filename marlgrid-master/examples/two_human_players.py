...
class HumanPlayer:
    ...
    def save_step(self, obs, act, rew, done):
        print(
            f"   step {self.step_count:<4d}: reward {rew} (episode total {self.cumulative_reward})")
...
env_config['agents'] = [player_interface_config, player_interface_config1]
